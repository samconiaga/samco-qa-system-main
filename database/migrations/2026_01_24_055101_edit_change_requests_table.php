...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            CHECK (overall_status IN ('Pending','Waiting SPV Approval','Waiting QA Manager Approval','Waiting Plant Manager Approval','Draft','In Progress','Reviewed' ,'Approved', 'Rejected','Waiting Close','Closed'))
        ");
